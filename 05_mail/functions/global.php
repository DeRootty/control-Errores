 ...
 */
if(file_exists(SM_PATH . 'functions/strings.php')){
    require_once(SM_PATH . 'functions/strings.php');
}else if(file_exists(SM_PATH . $miNombre->iknowiam .'/functions/strings.php')){
    require_once(SM_PATH . $miNombre->iknowiam .'/functions/strings.php');
}else{
    echo "ERROR de carga de archivo:" . SM_PATH . $miNombre->iknowiam .'/functions/strings.php';
    exit;
}
//require_once(SM_PATH . 'functions/strings.php');
...
}else if(file_exists(SM_PATH . $miNombre->iknowiam .'/config/config.php')){
    require_once(SM_PATH . $miNombre->iknowiam .'/config/config.php');
}else{
    echo "ERROR de carga de archivo:" . SM_PATH . $miNombre->iknowiam .'/config/config.php';
    exit;
}
...
/**
 * $name: Criterio de busqueda dentro de los arrays:
 *  1.- $_SESSION
 *  2.- $_POST
 *  3.- $_GET,
 *  4.- $_COOKIE
