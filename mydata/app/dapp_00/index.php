<?php declare(strict_types=1);
    ...
    exit;
iniciando:    
            //[0] => www.derootty.xyz/00_sendme/index.php?var=

    
/*
header('Location: /error/index.html');
exit;
echo "Estas en la pagina en construccion de enviame ";
exit;
*/
    //define('PAGE_NAME', 'index');
    //define('SM_PATH','../');
    $ruta=array();
    $ruta[]="admin/controller/whoami.php";
    $ruta[]="admin/stamp.php";
    try{    
