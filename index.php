 ...
 */
  ...
  namespace practicasAPP;
    ...
    try{
        ...
        //la misma clase tambien sera usada para obtener los permisos de carga de las apps
 ...
 */
    ...
    try{
        ...
        $modoRtm->registroMod("hola mundo en " . __FILE__ . " => " . __LINE__);
        $modoRtm->registroMod("----- hola mundo mundial " . BASE_PATH . FAIL_PATH . "/index.php");
