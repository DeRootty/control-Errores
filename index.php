 ...
 */
  ...
  namespace practicasAPP;
    ...
    final class modos{
        ...
        public function controlFlow(bool $flowCheck): int{

            $this->initIndex = $flowCheck;
    ...
    function initIndex(){
        ...
        try{
            ...
            $modoRtm->registroMod("hola mundo en superglobales ok " . __FILE__ . " => " . __LINE__);
            $modoRtm->registroMod("-----Registrando clase de modos");
    ...
    if(!$modoRtm->getFlow($modoRtm->controlFlow(initIndex()))){
        exit("revisar: " . __FILE__ . " => " . __LINE__);
    }
    $modoRtm->registroMod("Mi primer Hola mundo en " . __FILE__ . " => " . __LINE__);

    function myDatEngIndex(){
        global $modoRtm;
    ...
    $con_St = myDatEngIndex();// get_defined_constants(true);
    
    function rootIndex(){
        global $modoRtm, $con_St;
    ...
    settype($requireSuccess, "bool");
    $requireSuccess = rootIndex();
    if(!$requireSuccess){
        exit;
    }
