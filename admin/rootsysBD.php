<?php declare(strict_types=1);
    ...
    namespace practicasAPP\rootsysBD;
    use practicasAPP;
...
class cargaAdmin{
    ...
    public function dameDatos(object $lanzador, bool $check): array{
        ...
        try{
            ...
            array_push($salida["F"], $lanzador->accionRun(false));
        }
        return $salida;
    }
}
