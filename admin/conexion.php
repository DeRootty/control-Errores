<?php declare(strict_types=1);
    ...
    namespace practicasAPP\conecta;
    use practicasAPP;
    use dinamica;
    use Exception;
...
*/
    ...
    try{
        $setData=$defConn->dameDatos($queryCURL, false);
        if($setData["E"][0]){
        ...
        $tipoCnn="";
        $tipoCnn="carga";
        echo __FILE__ . " => " . __LINE__ . " queBD <br>\n<pre>\n";
        print_r($setData);
        echo "</pre>";
    }
    /* 
    ...
    $conn = new mydata\engine\getCURL(array("destino" => "constante", "variable" => "inicio", "carga" => "datosAcceso.php"), array($_SERVER["SERVER_NAME"], "mydata/engine", __FILE__), false);
