<?php
        class conexion{
             ...
             *      3 - dbname
             */
            public function __construct($adminBD){
                if(is_array($adminBD)&&count($adminBD)>0){
                    $this->servername = $adminBD[0];
                    $this->username = $adminBD[1];
                    $this->password = $adminBD[2];
                    $this->dbname = $adminBD[3];
        ...
        $adminCrud=new conexion($adminBD);
